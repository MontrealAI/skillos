...
Proof Gradient holdout success: **0.3625** · Static coordination: **0.1805** · Unverified propagation: **0.0469**
## Mechanism
```text
attempt
→ trace
...
```
## Proof gates
- ✅ **Holdout success uplift over static coordination** — required >= 6.0 percentage points; observed 18.20 pp
- ✅ **Value capture uplift over static coordination** — required >= 3.0 percentage points; observed 4.60 pp
- ✅ **Proof Gradient beats unverified propagation** — required >= 2.0 percentage points success uplift; observed 31.56 pp
- ✅ **Risk breach ceiling** — required <= 7.5%; observed 0.00%
- ✅ **Negative-control rejection** — required >= 95% rejected; observed 100.00%
- ✅ **Skill compounding release curve** — required final value capture > release 0 value capture; observed 0.0150 delta
## Baselines
| Mode | Success | Quality | Risk breach | Value capture |
|---|---:|---:|---:|---:|
| single | 3.59% | 39.89 | 1.80% | 21.17% |
| pool | 1.80% | 38.32 | 2.42% | 19.79% |
| static | 18.05% | 46.44 | 0.00% | 26.23% |
| unverified | 4.69% | 40.71 | 0.00% | 21.17% |
| proof_gradient | 36.25% | 51.20 | 0.00% | 30.83% |
