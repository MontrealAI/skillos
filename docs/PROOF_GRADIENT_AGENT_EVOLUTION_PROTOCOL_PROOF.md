...
Proof Gradient holdout success: **0.3648** · Static coordination: **0.1805** · Unverified propagation: **0.0375**
## Mechanism
```text
attempt
→ trace
...
```
## Proof gates
- ✅ **Holdout success uplift over static coordination** — required >= 6.0 percentage points; observed 18.43 pp
- ✅ **Value capture uplift over static coordination** — required >= 3.0 percentage points; observed 4.74 pp
- ✅ **Proof Gradient beats unverified propagation** — required >= 2.0 percentage points success uplift; observed 32.73 pp
- ✅ **Risk breach ceiling** — required <= 7.5%; observed 0.00%
- ✅ **Negative-control rejection** — required >= 95% rejected; observed 100.00%
- ✅ **Skill compounding release curve** — required final value capture > release 0 value capture; observed 0.0151 delta
## Baselines
| Mode | Success | Quality | Risk breach | Value capture |
|---|---:|---:|---:|---:|
| single | 3.59% | 39.84 | 1.56% | 21.14% |
| pool | 2.58% | 38.56 | 1.80% | 19.98% |
| static | 18.05% | 46.54 | 0.00% | 26.22% |
| unverified | 3.75% | 40.66 | 0.00% | 21.11% |
| proof_gradient | 36.48% | 51.32 | 0.00% | 30.96% |
