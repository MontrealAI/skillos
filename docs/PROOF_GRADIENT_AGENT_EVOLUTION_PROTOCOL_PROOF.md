...
Proof Gradient holdout success: **0.3336** · Static coordination: **0.1562** · Unverified propagation: **0.0375**
## Mechanism
```text
attempt
→ trace
...
```
## Proof gates
- ✅ **Holdout success uplift over static coordination** — required >= 6.0 percentage points; observed 17.74 pp
- ✅ **Value capture uplift over static coordination** — required >= 3.0 percentage points; observed 4.29 pp
- ✅ **Proof Gradient beats unverified propagation** — required >= 2.0 percentage points success uplift; observed 29.61 pp
...
|---|---:|---:|---:|---:|
| single | 3.59% | 40.07 | 1.72% | 21.25% |
| pool | 1.87% | 38.56 | 2.50% | 19.90% |
| static | 15.62% | 46.41 | 0.00% | 26.26% |
| unverified | 3.75% | 40.63 | 0.00% | 21.19% |
| proof_gradient | 33.36% | 50.87 | 0.00% | 30.55% |
