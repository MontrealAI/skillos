...
Proof Gradient holdout success: **0.3508** · Static coordination: **0.1695** · Unverified propagation: **0.0406**
## Mechanism
```text
attempt
→ trace
...
- ✅ **Proof Gradient beats unverified propagation** — required >= 2.0 percentage points success uplift; observed 31.02 pp
- ✅ **Risk breach ceiling** — required <= 7.5%; observed 0.00%
- ✅ **Negative-control rejection** — required >= 95% rejected; observed 100.00%
- ✅ **Skill compounding release curve** — required final value capture > release 0 value capture; observed 0.0107 delta
## Baselines
| Mode | Success | Quality | Risk breach | Value capture |
|---|---:|---:|---:|---:|
| single | 3.52% | 39.94 | 1.17% | 21.28% |
| pool | 1.95% | 38.45 | 1.95% | 19.78% |
| static | 16.95% | 46.47 | 0.00% | 26.26% |
| unverified | 4.06% | 40.59 | 0.00% | 21.08% |
| proof_gradient | 35.08% | 50.92 | 0.00% | 30.59% |
