...
Proof Gradient holdout success: **0.3594** · Static coordination: **0.1703** · Unverified propagation: **0.0453**
## Mechanism
```text
attempt
→ trace
...
|---|---:|---:|---:|---:|
| single | 3.91% | 40.06 | 1.80% | 21.25% |
| pool | 2.66% | 38.35 | 2.03% | 19.91% |
| static | 17.03% | 46.46 | 0.00% | 26.25% |
| unverified | 4.53% | 40.76 | 0.00% | 21.22% |
| proof_gradient | 35.94% | 51.20 | 0.00% | 30.87% |
