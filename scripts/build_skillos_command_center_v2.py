...
"""
    atomic(SITE/"index.html", layout("SkillOS Public Command Center v2","Home",index_body,generated_at))
...
def main() -> None:
    ...
    urls=["https://montrealai.github.io/skillos/"]+[f"https://montrealai.github.io/skillos/{x}" for x in ["proofs.html","actions.html","receipts.html","multi-agent.html","architecture.html","runbook.html"]]
