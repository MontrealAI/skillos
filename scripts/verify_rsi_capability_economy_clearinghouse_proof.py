...
PROOF = ROOT / "data" / "rsi-capability-economy-clearinghouse-proof.json"
...
def main() -> None:
    ...
    f=proof["final"]
    checks=[
        (proof["agent_system"]["virtual_specialist_agents"]>=1_000_000_000,"virtual specialist agents must be at least 1B"),
        (proof["agent_system"]["specialist_roles"]>=30_000_000,"specialist roles must be at least 30M"),
