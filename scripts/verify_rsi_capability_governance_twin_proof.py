...
PROOF = ROOT / "data" / "rsi-capability-governance-twin-proof.json"
...
def main() -> None:
    ...
    checks=[
        ...
        (f["policy_violation_rate_percent"]==0,"policy violation must be zero"),
        (f["shadow_production_gap_rate_percent"]==0,"shadow/production gap must be zero"),
