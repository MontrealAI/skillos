...
PROOF = ROOT / "data" / "rsi_enterprise_capability_foundry_proof.json"
...
def main() -> None:
    ...
    checks = [
        (agent_system["agent_count"] >= 4096, "agent_count must be at least 4096"),
        (agent_system["role_count"] >= 256, "role_count must be at least 256"),
    ...
    if failures:
        print("Autonomous RSI Enterprise Capability Foundry verification failed:")
